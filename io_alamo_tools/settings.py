...
material_parameter_dict = {
    ...
    "MeshBumpColorize.fx": ["Emissive", "Diffuse", "Specular", "Shininess", "Colorization", "UVOffset", "BaseTexture", "NormalTexture"],
    "MeshBumpColorizeVertex.fx": ["Emissive", "Diffuse", "Specular", "Shininess", "Colorization", "UVOffset", "BaseTexture", "NormalTexture"],
    "MeshBumpColorizeDetail.fx": ["Emissive", "Diffuse", "Specular", "Shininess", "Colorization", "UVOffset", "BaseTexture", "DetailTexture", "NormalTexture", "MappingScale", "BlendSharpness", "NormalDetailTexture"],
    "MeshBumpLight.fx": ["Emissive", "Diffuse", "Specular", "Shininess", "Colorization", "UVOffset", "BaseTexture", "NormalTexture"],
    ...
    "Planet.fx": ["Emissive", "Diffuse", "Specular", "Atmosphere", "CityColor", "AtmospherePower", "CloudScrollRate", "BaseTexture", "NormalTexture", "CloudTexture", "CloudNormalTexture"],
    "RSkinAdditive.fx": ["BaseTexture", "UVScrollRate", "Color"],
    "RSkinAlpha.fx": ["Emissive", "Diffuse", "Specular", "Shininess", "BaseTexture"],
    "RSkinBumpColorize.fx": ["Emissive", "Diffuse", "Specular", "Shininess", "Colorization", "UVOffset", "BaseTexture", "NormalTexture"],
    "RSkinGloss.fx": ["Emissive", "Diffuse", "Specular", "Shininess", "BaseTexture"],
    "RSkinGlossColorize.fx": ["Emissive", "Diffuse", "Specular", "Shininess", "Colorization", "BaseTexture", "GlossTexture"],
    ...
    "MeshBumpSpecColorize.fx": ["Emissive", "Diffuse", "Specular", "Shininess", "Colorization", "UVOffset", "BaseTexture", "NormalTexture", "GlossTexture"],
    ...
    "MeshBumpReflectColorize.fx": ["Emissive", "Diffuse", "Specular", "Shininess", "Colorization", "UVOffset",  "BaseTexture", "NormalTexture"]
}
